package it.thera.thip.api.client;
...
public class ApiClient {
	...
	public ApiClient(String apiPath,String token) {
	...
	public ApiResponse send(ApiRequest request) throws KeyManagementException, NoSuchAlgorithmException {
